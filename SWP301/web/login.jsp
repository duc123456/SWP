                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 d-flex align-items-end">
                            <ul class="ms-auto d-inline-flex">
                                <li class="p-2"><a target="_blank" href="login.jsp"><button class="btn px-4 btn-danger">Login</button></a></li>
                                <li class="p-2"><a target="_blank" href="signup.jsp"><button class="btn px-4 btn-outline-danger">Sign Up</button></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-6 col-lg-7 col-md-10 py-5 mx-auto">
                    <form class="login-card bg-white shadow-md p-5" action="login" method="post">
                        ...
                        <div class="form-row row">
                            ...
                            <div class="col-md-8">
                                <input type="text" nam="" placeholder="Enter Email Address" class="form-control" required="">
                            </div>
                        </div>
                         <div class="form-row row">
                            <div class="col-md-4 pt-2">
                            ...
                            <div class="col-md-8">
                                <input type="password" name="" placeholder="Enter Password" class="form-control" required="">
                            </div>
                        </div>
                        <div class="form-row row">
                            <div class="col-md-4 pt-2">
